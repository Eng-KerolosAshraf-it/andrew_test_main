...
const _tealColor = Color(0xFF0D9488);

final ValueNotifier<bool> technicianSidebarCollapsed = ValueNotifier<bool>(false);

// ── Sidebar ───────────────────────────────────────────────
class TechnicianSidebar extends StatelessWidget {
  const TechnicianSidebar({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return ValueListenableBuilder<bool>(
      valueListenable: technicianSidebarCollapsed,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                InkWell(
                                  onTap: () => technicianSidebarCollapsed.value = !isCollapsed,
                        ...
                        _SidebarItem(icon: Icons.dashboard_rounded,
                          ...
                          isActive: currentRoute == RouteNames.technicianDashboard,
                          isDark: isDark, isCollapsed: isCollapsed,
                          onTap: () => currentRoute != RouteNames.technicianDashboard
                              ? Navigator.pushNamed(context, RouteNames.technicianDashboard) : null),

                        _SidebarItem(icon: Icons.list_alt_rounded,
                          title: isAr ? 'مهامي' : 'My Tasks',
                          isActive: currentRoute == RouteNames.technicianTasks,
                          isDark: isDark, isCollapsed: isCollapsed,
                          onTap: () => currentRoute != RouteNames.technicianTasks
                              ? Navigator.pushReplacementNamed(context, RouteNames.technicianTasks) : null),

                        _SidebarItem(icon: Icons.upload_rounded,
                          title: isAr ? 'إثبات التنفيذ' : 'Execution Proof',
                          isActive: currentRoute == RouteNames.technicianExecution,
                          isDark: isDark, isCollapsed: isCollapsed,
                          onTap: () => currentRoute != RouteNames.technicianExecution
                              ? Navigator.pushReplacementNamed(context, RouteNames.technicianExecution) : null),

                        _SidebarItem(icon: Icons.settings_rounded,
                          title: isAr ? 'الإعدادات' : 'Settings',
                          isActive: currentRoute == RouteNames.technicianSettings,
                          isDark: isDark, isCollapsed: isCollapsed,
                          onTap: () => currentRoute != RouteNames.technicianSettings
                              ? Navigator.pushReplacementNamed(context, RouteNames.technicianSettings) : null),
              ...
              child: Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    border: Border.all(color: _tealColor.withValues(alpha: 0.4), width: 2),
                    image: imageBytes != null ? DecorationImage(image: MemoryImage(imageBytes), fit: BoxFit.cover) : null,
                  ),
                  child: imageBytes == null
                      ? Center(child: Text(initials, style: TextStyle(fontSize: 15, fontWeight: FontWeight.bold,
                          color: isDark ? Colors.white : _tealColor)))
                      : null,
                ),
                const SizedBox(width: 12),
                Expanded(child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    Text(name ?? 'Technician', style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold,
                        color: isDark ? Colors.white : AppColors.textPrimary), overflow: TextOverflow.ellipsis),
                    Text(isAr ? 'فني' : 'Technician',
  ...
  Widget build(BuildContext context) {
    return Tooltip(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          color: isActive
              ? (isDark ? _tealColor.withValues(alpha: 0.15) : _tealColor.withValues(alpha: 0.08))
              : Colors.transparent,
          borderRadius: BorderRadius.circular(8),
          border: isActive ? Border.all(color: _tealColor.withValues(alpha: 0.3)) : null,
        ),
        child: InkWell(
          onTap: onTap,
          borderRadius: BorderRadius.circular(8),
          child: SizedBox(
            ...
            child: Padding(
              ...
              child: Row(children: [
                Icon(icon, color: isActive ? _tealColor : (isDark ? Colors.white60 : AppColors.textSecondary), size: 20),
                if (!isCollapsed) ...[
                  const SizedBox(width: 12),
                  Expanded(child: Text(title,
                    overflow: TextOverflow.ellipsis,
                    style: TextStyle(
                      color: isActive ? (isDark ? Colors.white : _tealColor) : (isDark ? Colors.white60 : AppColors.textSecondary),
                      fontWeight: isActive ? FontWeight.bold : FontWeight.w500,
                      fontSize: 14,
                    ))),
                  if (isActive)
                    Container(width: 3, height: 20,
                      decoration: BoxDecoration(color: _tealColor, borderRadius: BorderRadius.circular(2))),
                ],
              ]),
            ),
          ),
...
class TechnicianHeader extends StatelessWidget {
  ...
  const TechnicianHeader({super.key, required this.isMobile, this.showSearch = true});
          ...
          builder: (context, themeMode, _) {
            ...
            return Container(
              ...
              child: Row(children: [
                ...
                // Logo → dashboard
                InkWell(
                  onTap: () => Navigator.pushNamed(context, '/technician/dashboard'),
                  borderRadius: BorderRadius.circular(8),
                  child: Row(children: [
                    Container(
                      width: 32, height: 32,
                      decoration: BoxDecoration(color: _tealColor, borderRadius: BorderRadius.circular(8)),
                ...
                // Notifications
                _NotificationButton(isDark: isDark, isAr: isAr),
                const SizedBox(width: 8),
...
class _NotificationButton extends StatefulWidget {
  final bool isDark, isAr;
  const _NotificationButton({required this.isDark, required this.isAr});
          ...
          onPressed: () {
            showDialog(
              ...
              builder: (context) => StatefulBuilder(
                builder: (context, setDialogState) => Stack(children: [
                  Positioned(
                    top: 70, right: 80,
                    child: Material(
                      elevation: 8,
                        ...
                        child: Column(mainAxisSize: MainAxisSize.min, children: [
                          Padding(
                            ...
                            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                              Text(widget.isAr ? 'الإشعارات' : 'Notifications',
                                style: TextStyle(fontWeight: FontWeight.bold, fontSize: 16,
                                    color: widget.isDark ? Colors.white : AppColors.textPrimary)),
                              if (_unreadCount > 0)
                                TextButton(onPressed: () async { await _markAllAsRead(); setDialogState(() {}); },
                                  child: Text(widget.isAr ? 'قراءة الكل' : 'Mark all read',
                                    style: const TextStyle(fontSize: 12, color: _tealColor))),
                            ]),
                          ),
                          ...
                          if (_isLoading)
                            ...
                            Padding(padding: const EdgeInsets.all(24), child: Column(children: [
                              ...
                              const SizedBox(height: 8),
                              Text(widget.isAr ? 'لا توجد إشعارات' : 'No notifications',
                            ...
                            Flexible(child: ListView.separated(
                              ...
                              itemBuilder: (context, index) {
                                ...
                                return Container(
                                  padding: const EdgeInsets.symmetric(horizontal: 16, vertical: 12),
                                  color: isUnread ? _tealColor.withValues(alpha: 0.05) : Colors.transparent,
                                  child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Container(width: 36, height: 36,
                                      decoration: BoxDecoration(color: _tealColor.withValues(alpha: 0.1), shape: BoxShape.circle),
                                      child: const Icon(Icons.notifications_none_outlined, size: 18, color: _tealColor)),
                                    const SizedBox(width: 12),
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Text(_formatDate(notif['created_at']),
                                        style: TextStyle(fontSize: 11, color: widget.isDark ? Colors.white38 : Colors.grey)),
                                    ])),
        ...
        return ValueListenableBuilder<Uint8List?>(
          ...
          builder: (context, imageBytes, _) {
            ...
            return PopupMenuButton<String>(
              ...
              onSelected: (value) {
                if (value == 'settings') Navigator.pushNamed(context, '/technician/settings');
              ...
              itemBuilder: (_) => [
                PopupMenuItem(enabled: false, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text(name ?? 'Technician', style: TextStyle(fontWeight: FontWeight.bold,
                      color: isDark ? Colors.white : AppColors.textPrimary)),
                  Text(userState.userEmail.value ?? '', style: const TextStyle(fontSize: 12, color: Colors.grey)),
                ])),
                const PopupMenuDivider(),
                PopupMenuItem(
                  onTap: () => technicianThemeNotifier.value = isDark ? ThemeMode.light : ThemeMode.dark,
                  child: Row(children: [
                    Icon(isDark ? Icons.light_mode_outlined : Icons.dark_mode_outlined,
                      size: 18, color: isDark ? Colors.amber : AppColors.textPrimary),
                    const SizedBox(width: 12),
                ...
                PopupMenuItem(enabled: false, child: Row(children: [
                  ...
                  const SizedBox(width: 12),
                  GestureDetector(
                    onTap: () => technicianLanguageNotifier.value = 'ar',
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      decoration: BoxDecoration(
                        color: technicianLanguageNotifier.value == 'ar' ? _tealColor : Colors.transparent,
                        borderRadius: const BorderRadius.horizontal(left: Radius.circular(6)),
                        border: Border.all(color: _tealColor),
                      ),
                      child: Text('AR', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,
                        color: technicianLanguageNotifier.value == 'ar' ? Colors.white : _tealColor)),
                    ),
                  ),
                  GestureDetector(
                    onTap: () => technicianLanguageNotifier.value = 'en',
                    child: Container(
                      padding: const EdgeInsets.symmetric(horizontal: 10, vertical: 4),
                      decoration: BoxDecoration(
                        color: technicianLanguageNotifier.value == 'en' ? _tealColor : Colors.transparent,
                        borderRadius: const BorderRadius.horizontal(right: Radius.circular(6)),
                        border: Border.all(color: _tealColor),
                      ),
                      child: Text('EN', style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold,
                        color: technicianLanguageNotifier.value == 'en' ? Colors.white : _tealColor)),
                    ),
                  ),
                ])),
                const PopupMenuDivider(),
              ...
              child: Row(children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    shape: BoxShape.circle,
                    color: _tealColor.withValues(alpha: 0.15),
                    border: Border.all(color: _tealColor.withValues(alpha: 0.5), width: 2),
                    image: imageBytes != null ? DecorationImage(image: MemoryImage(imageBytes), fit: BoxFit.cover) : null,
                  ),
                  child: imageBytes == null
                      ? Center(child: Text(initials, style: TextStyle(fontSize: 14, fontWeight: FontWeight.bold,
                          color: isDark ? Colors.white : _tealColor)))
                      : null,
                ),
